...
if __name__ == '__main__':
    ...
    Ks = np.arange(0.02, 0.025, 0.0005)         #DESDE MEANDEGREE = 25 PARA ARRIBA HAY QUE USAR T TOTAL 15000, PARA ABAJO DE ESE VALOR SE PUEDE USAR T TOTAL DE 10000
    samples = [0]
    ...
    for k in Ks:
        ...
        for sample in samples:
            ...
            initial_quimera = numero = np.random.randint(0, N_nodes)
