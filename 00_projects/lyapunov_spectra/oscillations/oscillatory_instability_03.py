...
if __name__ == '__main__':
    ...
    for directory_i in directories:
        ...
        for directory_j in sub_directories:
            ...
            Z_r = np.loadtxt(subdirectory + '/field_real.txt', delimiter=',')
            Z_i = np.loadtxt(subdirectory+ '/field_img.txt', delimiter=',')
            X = np.loadtxt(subdirectory + '/X.txt', delimiter=',')
            T = np.loadtxt(subdirectory + '/T.txt', delimiter=',')
            ...
            print("Detected structures: " + str(K))
            ...
            np.savetxt(subdirectory + '/Z_r_points.txt', Z_r_points_np, delimiter=',')
            np.savetxt(subdirectory + '/Z_i_points.txt', Z_i_points_np, delimiter=',')
            np.savetxt(subdirectory + '/x_points.txt', x_points_np, delimiter=',')
            np.savetxt(subdirectory + '/t_points.txt', t_points_np, delimiter=',')
        ...
        np.savetxt(subdirectory + '/param.txt', param, delimiter=',')
        np.savetxt(subdirectory + '/freq.txt', freq, delimiter=',')
        np.savetxt(subdirectory + '/ampd.txt', ampd, delimiter=',')
        np.savetxt(subdirectory + '/power.txt', av_power, delimiter=',')
        ...
        plt.tight_layout()
        plt.savefig(subdirectory + '/freq_oscillations.png', dpi=300)
        plt.close()
        ...
        plt.tight_layout()
        plt.savefig(subdirectory + '/ampd_oscillations.png', dpi=300)
        plt.close()
        ...
        plt.tight_layout()
        plt.savefig(subdirectory + '/power_oscillations.png', dpi=300)
        plt.close()
