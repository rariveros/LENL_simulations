...
if __name__ == '__main__':
    ...
    np.savetxt(data_out + '/coef_real_dist.txt', index_01, delimiter=',')
    np.savetxt(data_out + '/coef_imag_dist.txt', index_02, delimiter=',')
    np.savetxt(data_out + '/coef_dist.txt', parameters, delimiter=',')
    ...
    plt.savefig(data_out + '/coef_dist.png', dpi=300)
    plt.close()
