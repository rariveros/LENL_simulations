...
if __name__ == '__main__':
    ...
    #plt.errorbar(distances_01a, 2 * freqs_01a[:, 0], freqs_01a[:, 1], marker='o', ls='', ecolor="k", mec='black', color="green", label='$\\nu=0.020$', alpha=alpha)

    #plt.errorbar(distances_02, 2 * freqs_02[:, 0], freqs_02[:, 1], marker='o', ls='', ecolor="k", mec='black', color="purple", label='$\\nu=0.025$', alpha=alpha)
    #plt.errorbar(distances_03, 2 * freqs_03[:, 0], freqs_03[:, 1], marker='o', ls='', ecolor="k", mec='black', color="gold", label='$\\nu=0.030$', alpha=alpha)
    #plt.errorbar(distances_04, 2 * freqs_04[:, 0], freqs_04[:, 1], marker='o', ls='', ecolor="k", mec='black', color="red", label='$\\nu=0.035$', alpha=alpha)
    #plt.errorbar(distances_05, 2 * freqs_05[:, 0], freqs_05[:, 1], marker='o', ls='', ecolor="k", mec='black', color="cyan", label='$\\nu=0.040$', alpha=alpha)
    #plt.errorbar(distances_06, 2 * freqs_06[:, 0], freqs_06[:, 1], marker='o', ls='', ecolor="k", mec='black', color="blue", label='$\\nu=0.045$', alpha=alpha)
    #plt.errorbar(distances_07, 2 * freqs_07[:, 0], freqs_07[:, 1], marker='o', ls='', ecolor="k", mec='black', color="purple", label='$\\nu=0.050$', alpha=alpha)
