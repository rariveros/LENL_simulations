...
if __name__ == "__main__":
    ...
    x_grid = np.loadtxt(directory + '/analysis/x_grid.txt', delimiter=',')
    ...
    phi_R = np.loadtxt( directory + '/analysis/ansatz_right.txt', delimiter=',', dtype=complex)
    phi_L = np.loadtxt(directory + '/analysis/ansatz_left.txt', delimiter=',', dtype=complex)
