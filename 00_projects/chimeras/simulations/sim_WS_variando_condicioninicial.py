...
if __name__ == '__main__':
    ...
    ###########################################################
    project_name = '/NW_chimeras/watts_strogatz/simulations_v3'
    disc = 'C:/'
    ...
    for k in Ks:
        ...
        for sample in samples:
            ...
            subfile = "/k=" + k_str + "/beta=" + beta_str + "/sample=" + sample_str
            ...
            # Orden natural
            cax_01 = ax01.pcolormesh(x_grid, t_light[i_0:i_f:each], module[i_0:i_f:each, :], cmap="turbo", shading='auto')
            ...
            cax_02 = ax02.pcolormesh(x_grid, t_light[i_0:i_f:each], module[i_0:i_f:each, args], cmap="turbo", shading='auto')
