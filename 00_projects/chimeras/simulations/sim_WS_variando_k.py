...
===========================================================
 Objetivo:
 ---------
 Este código simula osciladores de Duffing en redes 
 Erdős–Rényi, explorando la dinámica al variar el 
 parámetro de acoplamiento k.

 - Corre simulaciones para distintos valores de k.
 - Genera una nueva red en cada simulación.
...
if __name__ == '__main__':
    ...
    ###########################################################
    project_name = '/NW_chimeras/watts_strogatz/simulations_v1/'
    disc = 'C:/'
    ...
    for k in Ks:
        ...
        for beta in betas:
            ...
            for sample in samples:
                ...
                ###########################################################
                p = mean_degree / (n - 1)
                graph = watts_strogatz_graph_connected(n, mean_degree, beta)
                ...
                k_str = f"{k:.{4}f}"
                mean_degree_str = f"{beta:.{4}f}"
                sample_str = f"{sample:.{2}f}"
                subfile = "/k=" + k_str + "/beta=" + mean_degree_str + "/sample=" + sample_str
