...
if __name__ == '__main__':
    ...
    project_name = '/variational_pdnlS/localized_patterns'
    ...
    for i in ies:
        ...
        for j in jes:
            ...
            np.savetxt(file + subfile + '/field_real_0.txt', U1_light[-1, :], delimiter=',')
            np.savetxt(file + subfile + '/field_img_0.txt', U2_light[-1, :], delimiter=',')
